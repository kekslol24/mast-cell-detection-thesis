...
The data used in this report stems from BM smears from the USZ. This data is intended for the manual classification of of atypical vs normal MC. For this specific thesis the data has been handed out to be worked with while training the models.
